...
class BidderMicroservice {
    ...
    private var myName = "Bidder" + (1..5).map { (('a'..'z') + ('0'..'9')).random() }.joinToString("")
    private val myPhone= (1..10).
    map { ('0'..'9').random() }.joinToString("")
    private val myEmail = (1..10).map { ('a'..'z').random() }.joinToString("") +
            "@gmail.com"
    ...
    init {
        try {
            ...
            myIdentity = "[$myName,$myPhone,$myEmail]"
