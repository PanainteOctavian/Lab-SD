...
if __name__ == '__main__':
    ...
    lista_topicuri = [
        ...
        NewTopic(name=used_topics[5], num_partitions=1, replication_factor=1),
        NewTopic(name=used_topics[6], num_partitions=1, replication_factor=1),
    ]
