...
class BiddingProcessor:
    ...
    def decide_auction_winner(self, bids):
        ...
        # se trimite rezultatul licitatiei pentru ca entitatile Bidder sa il preia din topicul
        # corespunzator
        self.result_producer.send(topic=self.result_topic, value=winner.value,
