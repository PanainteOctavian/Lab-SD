    ...
    fun run() {
        ...
        runBlocking {
            while (true) {
                ...
                if (response == null) {
                    // daca se primeste un mesaj gol (NULL), atunci inseamna ca cealalta parte a
                    // socket-ului a fost inchisa
                    println("Microserviciul MessageService (${messageManagerSocket.port}) a fost " +
                            "oprit.")
                    bufferReader.close()
                ...
                launch(Dispatchers.IO) {
                    ...
                    when(messageType) {
                        ...
                        "intrebare" -> {
                            println("Am primit o intrebare de la $messageDestination:" +
                                    " \"${messageBody}\"")
